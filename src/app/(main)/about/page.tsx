...
import Image from "next/link"; // (ملاحظة: سنستخدم img العادية للصورة الشخصية لتسهيل الأمر)
import {
  GraduationCap,
  Award,
  BookOpen,
          ...
          <div className="px-6 pb-8 text-center relative">
            ...
            <div className="relative -mt-16 mb-6 inline-block">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white shadow-lg overflow-hidden bg-gray-200 mx-auto relative group">
                {/* ⚠️ هام: استبدل الرابط أدناه برابط الصورة الشخصية الحقيقية 
                  أو ضع الصورة في مجلد public واستخدم المسار: /profile.jpg
                */}
                <img
